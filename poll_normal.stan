...
data {
  ...
  real<lower=0> a1; //hyperparameter for gamma hyper prior
  real<lower=0> b1; //hyperparameter for gamma hyper prior
}
...
model {
  alpha ~ normal(a1,b1);   //vector alpha consists of K = 3 random draws, prior distribution for alpha
